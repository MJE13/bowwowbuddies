...
export default class MessagePane extends Component {
  ...
  render(){ 
    return (<div> {this.props.messages.map(message => <Message message={message}/>)}</div>) // takes each component of the messages array and it is assigning it as a message component
  }
}
